...
#ifndef ISING_CONFIG_H
#define ISING_CONFIG_H
...
struct loop_config {
  ...
  // graph for loops
  typedef looper::local_graph<looper::site_graph_type, looper::ising_bond_graph_type> loop_graph_t;
